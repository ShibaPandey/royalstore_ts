    ...
    <>
      <footer className="relative bg-gray-900 text-white pt-16 pb-8">
        ...
        <div className="max-w-7xl mx-auto px-5 grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-10 relative z-10">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl text-green-600 mb-6 border-b-2 border-green-600 pb-2">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4 mb-6">
              ...
              <li className="flex items-start gap-4">
                <i className="fas fa-phone-alt text-green-600 mt-1" />
                <div>
                  <a
                    href="tel:+1 6315655576"
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  <a
                    href="nepalikhukuri@gmail.com"
                    className="block hover:underline opacity-90 hover:opacity-100"
                  >
                    nepalikhukuri@gmail.com
                  </a>
                </div>
              </li>
            </ul>
            {/* Newsletter */}
            <h3 className="text-xl text-green-600 mb-2 border-b-2 border-green-600 pb-2">
              Newsletter
            </h3>
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-green-600 hover:bg-green-500 text-white p-3 rounded-r-md transition"
              >
        ...
        <div className="mt-16 pt-8 border-t border-gray-700 text-center opacity-70 text-sm">
          <p>
            © 2025 Tab Creative Studio. All Rights Reserved. | Designed with{" "}
